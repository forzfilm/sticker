...
class ApplyMakeup(DetectLandmarks):
    ...
    def __fill_lip_solid(self, outer, inner):
        ...
        gradient_outer = self.linear_gradient("#2200FF","#2200FF",len_outer)
        gradient_inner = self.linear_gradient("#2200FF","#00F9FF",len_inner)
        i = 0
        points = []
    ...
    def __fill_color(self, uol_c, uil_c, lol_c, lil_c):
        ...
        self.__add_color(0.9)

    def __fill_color_bottom(self, uol_c, uil_c, lol_c, lil_c):
        """ Fill colour in lips. """
        self.__fill_lip_lines(uol_c, uil_c)
        self.__fill_lip_lines(lol_c, lil_c)
        self.__add_color(0.5)
    ...
    def __fill_color_upper(self, uol_c, uil_c, lol_c, lil_c):
        """ Fill colour in lips. """
        self.__fill_lip_lines(uol_c, uil_c)
        self.__fill_lip_lines(lol_c, lil_c)
        self.__add_color(0.5)
    ...
    def apply_lipstick(self, filename, rlips, glips, blips,position):
        ...
        if position == "upper":
            self.__fill_color_upper(uol_c, uil_c, lol_c, lil_c)
        elif position == "bottom":
            self.__fill_color_bottom(uol_c, uil_c, lol_c, lil_c)
        else:
