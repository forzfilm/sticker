...
class ApplyMakeup(DetectLandmarks):
    ...
    def apply_lipstick(self, filename, rlips, glips, blips,position):
        ...
        ##########################UPPER
        upper_lips_0 = uol_c[0]+uil_c[0]
        upper_lips_1 = uol_c[1]+uil_c[1]
        upper_lips_temp = (upper_lips_0,upper_lips_1)
        upper_lips_outer = []
        upper_lips_inner = []
        upper_lips_outer_0 = []
        upper_lips_outer_1 = []
        ...
        upper_lips_inner_1 = []
        i = 0
        for x in upper_lips_temp[0]:
            if i <= len(upper_lips_temp[0])/2:
                upper_lips_outer_0.append(x)
            else:
                upper_lips_inner_0.append(x)
            i += 1
        i = 0
        for y in upper_lips_temp[1]:
            if i <= len(upper_lips_temp[1])/2:
                upper_lips_outer_1.append(y)
            else:
                upper_lips_inner_1.append(y)
            i += 1
        upper_lips_outer = (upper_lips_outer_0,upper_lips_outer_1)
        upper_lips_inner = (upper_lips_inner_0,upper_lips_inner_1)

        print("Upper outer old %s inner %s",(uol_c[0],uil_c[0]))
        print("Upper outer new %s inner %s",(sorted(upper_lips_outer_0),sorted(upper_lips_inner_0)))
        ###################BOTTOM
        bottom_lips_0 = lol_c[0]+lil_c[0]
        bottom_lips_1 = lol_c[1]+lil_c[1]
        bottom_lips_temp = (bottom_lips_0,bottom_lips_1)
        bottom_lips_outer = []
        bottom_lips_inner = []
        bottom_lips_outer_0 = []
        bottom_lips_outer_1 = []
        ...
        bottom_lips_inner_1 = []
        i = 0
        for x in bottom_lips_temp[0]:
            if i <= len(bottom_lips_temp[0])/2:
                bottom_lips_outer_0.append(x)
            else:
                bottom_lips_inner_0.append(x)
            i += 1
        i = 0
        for y in bottom_lips_temp[1]:
            if i <= len(bottom_lips_temp[1])/2:
                bottom_lips_outer_1.append(y)
            else:
                bottom_lips_inner_1.append(y)
            i += 1
        bottom_lips_outer = (bottom_lips_outer_0,bottom_lips_outer_1)
        bottom_lips_inner = (bottom_lips_inner_0,bottom_lips_inner_1)
        if position == "upper":
            self.__fill_color_upper(sorted(upper_lips_outer), sorted(upper_lips_inner), sorted(bottom_lips_outer), sorted(bottom_lips_inner),"#000000","#000000","#000000","#000000")
        elif position == "bottom":
            self.__fill_color_bottom(sorted(upper_lips_outer), sorted(upper_lips_inner), sorted(bottom_lips_outer), sorted(bottom_lips_inner),"#000000","#000000","#000000","#000000")
        else:
            self.__fill_color(sorted(upper_lips_outer), sorted(upper_lips_inner), sorted(bottom_lips_outer), sorted(bottom_lips_inner))
