...
class ApplyMakeup(DetectLandmarks):
    ...
    def apply_lipstick(self, filename, rlips, glips, blips,position):
        ...
        if position == "upper":
            self.__fill_color_upper(uol_c, uil_c, lol_c, lil_c,"#800000","#800000","#8A2BE2","#8A2BE2")
        elif position == "bottom":
            self.__fill_color_bottom(uol_c, uil_c, lol_c, lil_c,"#000000","#000000","#191970","#191970")
        else:
